...
export const AddButton = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="43" height="35.56" viewBox="0 0 43 35.56">
    <g id="table-add-button" transform="translate(-0.1 35.56) rotate(-90)">
      <path id="table-add-icon" d="M17,.1c9.416,0,17,7.953,17,17.793,0,4.987-2.616,10.245-9.547,17.389L17,43.1,9.416,35.282C2.616,28,0,22.746,0,17.893,0,8.053,7.585.1,17,.1Z" transform="translate(0 0)" fill="#772432" fillRule="evenodd"/>
...
export const RemoveButton = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="42.942" height="35" viewBox="0 0 42.942 35">
    <g id="table-delete-button" transform="translate(-0.1 35) rotate(-90)">
      <path id="table-add-icon" d="M17.5.1A17.61,17.61,0,0,1,35,17.869c0,4.981-2.692,10.231-9.827,17.365L17.5,43.042,9.692,35.235C2.692,27.965,0,22.715,0,17.869A17.61,17.61,0,0,1,17.5.1Z" transform="translate(0 0)" fill="#ff002b" fillRule="evenodd"/>
